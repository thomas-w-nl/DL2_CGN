...
def sample_classes(mode, classes=None):
    ...
    elif mode == 'imagenet_a':
        return [np.random.choice(IMAGENET_A_CLASSES),
                np.random.choice(IMAGENET_A_CLASSES),
                np.random.choice(IMAGENET_A_CLASSES)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, required=True,
                        choices=['random', 'best_classes', 'fixed_classes', 'imagenet_a'],
