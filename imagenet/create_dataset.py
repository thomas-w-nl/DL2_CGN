...
def generate_images(args):
    ...
    with torch.no_grad():
        for i in tqdm.trange(args.n_data):
            ...
            y_vec = torch.tensor(np.random.choice(IMAGENET_A_CLASSES, 1))
            text_label = idx_to_class[y_vec.item()]
            print(text_label)
            ...
            to_pil(x_gen).save(dataset_path + f"{i}_gen_{class_label}_.png")
            # im = to_pil(x_gen)
            # im.show(title=text_label)
